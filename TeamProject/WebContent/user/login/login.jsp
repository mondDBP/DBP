	...
	<div class="membership_wrap">
		<div class="membership_body">
			...
			<form class="userBox" autocomplete="on" name="loginForm" method="POST" action="<c:url value='/user/login' />">
				...
				<!-- 이메일  name: email -->
				<input type="text" class="inputTag" placeholder="아이디 입력" name="userId" value=''>
				
				<label class="signIn" for="password">비밀번호</label>
					
				<!-- 비밀번호  name: pwd-->
				<input type="password" class="inputTag" name="password" value='' placeholder="비밀번호 입력" autocomplete="current-password" autocapitalize="off" autocorrect="off" spellcheck="off">

				<!-- 로그인 버튼! loginCheck() 메소드로-->
				<button class="loginButton" type="submit" label="로그인하기" onclick="login()" style="margin: 20px 0; height: 45px;">로그인</button>
				...
				<a class="idExist" href="<c:url value='/user/register/terms.jsp' />"><span style="color: #757575;" data-reactid="57">아직 계정이 없으신가요?</span> 텀블벅 가입하기</a>
			</form>

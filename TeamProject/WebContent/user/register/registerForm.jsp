...
<form  role="form" name="form" method="POST" action="<c:url value='/user/register' />">
	    ...
	    <c:if test="${registerFailed}">
         ...
         <div class="form-group" id="divPasswordCheck">
                ...
                <div class="col-lg-5">
                    <input type="text" name="name" class="form-control onlyHangul" id="name" data-rule-required="true" placeholder="이름" maxlength="10"
	     ...
	     <div class="form-group" id="divEmail">
          ...
          <br>
            <br>    
	     <div class="form-group" id="divResid"  style="clear:both">
...
<div style="margin-left:12px;">
           ...
           <div class="card border-light mb-3" style="clear:both;float:left;max-width: 40rem;">
 	     	 <div class="card-header">관심분야</div>
 		 	<div class="card-body">
 		     <p class="card-text">
